<?php
class UniversidadeControle extends TStandardFormList
{
    ...
    public function __construct()
    {
        ...
        parent::setActiveRecord('Universidade'); // define the Active Record
        parent::setDefaultOrder('id', 'asc'); // define the default order
        $this->setLimit(10); // turn off limit for datagrid
        
        // create the form
        $this->form = new TQuickForm('formularioUniversidade');
        $this->form->class = 'tform'; // CSS class
        $this->form->setFormTitle('Universidade');
        
        // create the form fields
        $id     = new TEntry('id');
        $name   = new TEntry('universidade');
        
        // add the form fields
        $this->form->addQuickField('ID',    $id,    '30%');
        $this->form->addQuickField('Nome',  $name,  '70%', new TRequiredValidator);
        ...
        $this->datagrid->addQuickColumn('Nome', 'universidade','left',  '80%', new TAction(array($this, 'onReload')), array('order', 'universidade'));
